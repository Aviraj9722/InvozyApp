...
public partial class eOrderTouchContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblKitchenCounter>(entity =>
        {
            entity.ToTable("tblKitchenCounter");

            entity.Property(e => e.Name)
                  .HasMaxLength(100);

            entity.HasOne(d => d.Business)
                  .WithMany(p => p.TblKitchenCounters)
                  .HasForeignKey(d => d.BusinessId)
                  .HasConstraintName("FK_tblKitchenCounter_tblBusinesses");
        });
